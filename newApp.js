...
// html dosyasındaki bölümleri alıyoruz.
const btnContainer = document.querySelector(".btn-container");
const menuContainer = document.querySelector(".section-center");

// öncelikle sayfadaki butonları oluşturuyoruz.
...
// oluşturduğumuz butonları html dosyasındaki bölüme ekliyoruz..
const buttons = () => {
    btnContainer.innerHTML = createButton("All") + " " + createButton("Korea") + " " + createButton("Japan") + " " + createButton("China")
};

buttons(); // butonları çağırıyoruz.


// butonlara tıklandığındaki çalışacak fonksiyoları atama işlemi.
...
//butonlara atadığımız fonksiyonları oluşturuyoruz.
...
// menüdeki yemekleri sayfada göstermeye yarayan fonskiyon.
...
getAllFoods(); // sayfada default olarak ilk açılışta bütün menünün gözükmesi için bu fonksiyonu çağırıyoruz.
